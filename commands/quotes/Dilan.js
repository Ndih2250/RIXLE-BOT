...
${json}
`
conn.sendButtonLoc(m.chat, await ( await fetch('https://telegra.ph/file/db171335f79e5eeceefe4.jpg')).buffer(), J, userbot.packname, 'Owner🗿', `${userbot.prefix}creator`, `🔰Next➡️`, `${userbot.prefix}dilan`, m)
